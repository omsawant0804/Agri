...
import 'package:cropinsights2/widget/Data.dart';
        ...
        builder:(context,AsyncSnapshot snapshot){
          return snapshot.hasData? ListView.builder(
              ...
              return Container(
                ...
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0, 20, 0, 0),                  child: Material(
                  elevation: 10,
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Crop Type : "+ds["cropsname"], style: TextStyle(color: Colors.black, fontSize: 20.0, fontWeight: FontWeight.bold),),
                        Text("Soil Type : "+ds["soilType"], style: TextStyle(color: Colors.black, fontSize: 20.0, fontWeight: FontWeight.bold),)
                      ],
                    ),
                  ),
                ),
      ...
      body: SafeArea(
        ...
        child: Stack(
          children: [
            ...
            Align(
              alignment: AlignmentDirectional(-0.20, 0.16),
            ),
          ],
        ),
      ),
